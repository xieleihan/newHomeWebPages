...
const codeBox = document.querySelector(".programmingLanguage");
console.log(codeBox);
console.log(codeBox.offsetWidth);
console.log(codeBox.offsetHeight);

// 获取窗口尺寸，防止失真
const width = codeBox.offsetWidth * window.devicePixelRatio;
const height = codeBox.offsetHeight * window.devicePixelRatio;

// 设置canvas尺寸为窗口尺寸
cvs.width = codeBox.offsetWidth;
cvs.height = codeBox.offsetHeight;
